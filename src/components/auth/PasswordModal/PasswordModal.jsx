    ...
    return (
        <div>
            ...
            <div css={s.header}>
                ...
                <p css={s.headerMessage}>비밀번호는 최소 8자 이상 20자 이하의 영문, 숫자 조합을 사용하세요.</p>
            </div>
            <div>
                ...
                {
                    passwordValue.newPassword !== passwordValue.confirmPassword &&
                    <p css={s.warningMessage}>패스워드가 일치하지 않습니다.</p>
                }
                <button css={s.setButton} 
                        disabled={!passwordValue.newPassword || !passwordValue.confirmPassword || passwordValue.newPassword !== passwordValue.confirmPassword} onClick={handleSetButtonOnClick}>Set a password</button>
            </div>
        </div>
    );
}
